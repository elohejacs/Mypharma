...
import { Plus, Edit, Trash2, X, Users, Truck, Tag, CreditCard, DollarSign, Lock } from 'lucide-react';
      ...
      <div className="content-area">
        ...
        <div style={{ 
          ...
          <div style={{ textAlign: 'center', marginBottom: '24px' }}>
            ...
            <h2 style={{ fontSize: '20px', marginBottom: '8px', color: '#1e293b' }}>Enter Admin PIN</h2>
